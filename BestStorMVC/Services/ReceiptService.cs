...
namespace BestStorMVC.Services
{
    public class ReceiptService
    {
        private const string storeName = "BestStore";
        ...
        public byte[] CreateReceiptPdf(Order order)
        {
            using (var ms = new MemoryStream())
            {
                ...
                Image logo = new Image(imageData).SetHeight(80).SetHorizontalAlignment(HorizontalAlignment.CENTER);
                document.Add(logo);
