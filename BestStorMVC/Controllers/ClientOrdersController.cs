    ...
    public class ClientOrdersController : Controller
    {
        ...
        public async Task<IActionResult> DownloadReceipt(int id)
        {
            ...
            var order = await context.Orders.Include(o => o.Items)
                .ThenInclude(oi => oi.Product)
                .Where(o => o.ClientId == currentUser.Id).FirstOrDefaultAsync(o => o.Id == id);
            ...
            byte[] pdf = receiptService.CreateReceiptPdf(order);

            return File(pdf, "application/pdf", $"Order_{order.Id}_Receipt.pdf");
        }
